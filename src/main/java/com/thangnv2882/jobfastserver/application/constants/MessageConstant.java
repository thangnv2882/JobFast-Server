...
public class MessageConstant {
  public static final String ACTIVE_FALSE = "ACTIVATION CODE is incorrect";
  public static final String ACCOUNT_NOT_EXISTS = "Account not exists";
  public static final String JOB_NOT_EXISTS = "Job not exists";
  ...
  public static final String JOB_DETAIL_NOT_EXISTS = "Unable to update";
